...
namespace PSIUWeb.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public CategoryController(ICategoryRepository repo, AppDbContext context)
        { 
        ...
        public IActionResult Edit(int? id)
        {
            ...
            ViewData["CategoryID"] = new SelectList(_context.Categories, "Id", "Name", c.ParentId);
        ...
        public IActionResult Insert(int? parentId)
        {
            ...
            ViewData["CategoryID"] = new SelectList(_context.Categories, "Id", "Name", parentId );
            return View();
        }
